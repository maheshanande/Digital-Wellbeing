...
import com.example.digital_wellbeing.custom_component.MainFragmentListview;
 ...
 * Main UI Fragment
 */
public class Your_Activity extends Fragment {

    public static final String TAG = "Your_Activity";
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        if (bgService == null) {
            setBgService(new Intent(Your_Activity.this.getActivity(), BackgroundService.class));
