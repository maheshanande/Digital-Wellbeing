package com.example.digital_wellbeing.settings;
...
import com.example.digital_wellbeing.DbManager;
import com.example.digital_wellbeing.NotificationBoradcastReceiver;
import com.example.digital_wellbeing.NotificationsHandler;
import com.example.digital_wellbeing.R;
import com.example.digital_wellbeing.Utils.Utils;
        ...
        myPref.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
            public boolean onPreferenceClick(Preference preference) {
                Intent emailIntent = new Intent(Intent.ACTION_SENDTO, Uri.fromParts(
                        "mailto","maheshanande6@gmail.com", null));
