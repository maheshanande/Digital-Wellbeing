package com.example.digital_wellbeing.Productivity;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        try {
            ...
            if (singleTask.get("status").contentEquals("1")) {
                ...
                Toast.makeText(activity.getApplicationContext(), "You have Completed the Task(:\n"+holder.task_name.getText(), Toast.LENGTH_SHORT).show();
            } else {
